...
with DAG('zillow_analytics_dag',
	...
	load_to_s3 = BashOperator(
		...
		bash_command = 'aws s3 mv {{ti.xcom_pull("tsk_extract_zillow_data_var")[0]}} s3://lucascampos/bronze/'
	)
	
	is_file_in_s3_available = S3KeySensor(
        task_id='tsk_is_file_in_s3_available',
        bucket_key='gold/{{ti.xcom_pull("tsk_extract_zillow_data_var")[1]}}',
	...
	transfer_s3_to_redshift = S3ToRedshiftOperator(
        ...
        s3_bucket=s3_bucket,
        s3_key='gold/{{ti.xcom_pull("tsk_extract_zillow_data_var")[1]}}',
        schema="PUBLIC",
        table="zillowdata",
